...
<body>
    ...
    <form action="GCMController" method="post">
		<label>Broadcast Message </label>
		<br /><input type="text" name="CollapseKey" value="<%=collapseKey %>" />
		<br/><textarea name="Message" rows="3" cols="60" ><%=message %> </textarea> 
                <br /><input type="text" name="latitude" value="<%=27.701893424898223 %>" />
                <br /><input type="text" name="longitude" value="<%=85.28655644506216 %>" />
